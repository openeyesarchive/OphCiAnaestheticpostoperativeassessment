...
/**
 * This is the model class for table "et_ophcianaestheticpoassessment_dischargecriteria".
 *
 ...
 * @property integer $mews_score
 * @property integer $nausea_vomiting
...
class Element_OphCiAnaestheticpostoperativeassessment_DischargeCriteria extends BaseEventTypeElement
{
	/**
	...
	{
		return 'et_ophcianaestheticpoassessment_dischargecriteria';
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'event_id' => 'Event',
			'pain_score' => 'Pain score 1 or less',
			'apvu' => 'APVU',
			'mews_score' => 'MEWS score 1 or less',
			'nausea_vomiting' => 'Nausea/vomiting score 1 or less',
			'blood_loss' => 'Blood loss score 1 or less',
			'blood_sugar' => 'Blood sugar in range',
		);
	}
